...
(There is a known bug where sometimes these jobs appear as failed despite having successfully built the image https://github.com/cert-manager/testing/issues/602)
